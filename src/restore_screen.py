...
class UI(QWidget):
    ...
    def widgets(self):
        ...
        ################################################################################
        self.filesVLayout = QVBoxLayout(scrollWidget) # scrollWidget
        self.filesVLayout.setAlignment(QtCore.Qt.AlignTop)
        self.filesVLayout.setContentsMargins(20, 20, 20, 20)
        self.filesVLayout.setSpacing(0)
        ...
        self.upButton.setFont(QFont(self.font4, 12))
        ...
        self.downButton.setFont(QFont(self.font4, 12))
    ...
    def get_time(self, getDate):
        ...
        for getTime in os.listdir(f"{self.getExternalLocation}/TMB/{getDate}/"):
            ...
            self.timeButton.setFont(QFont(self.font2, 12))
    ...
    def show_on_screen(self, getDate, getTime):
        ...
        ## Remove items
        ################################################################################
        for i in range(self.filesVLayout.count()):
            item = self.filesVLayout.itemAt(i)
            widget = item.widget()
            widget.deleteLater()
            i -=1
        ...
        try:
            for output in os.listdir(f"{self.getExternalLocation}/TMB/{getDate}/{getTime}/{self.reader}"):
                if "." in output and not output.startswith("."):
                    ...
                    self.buttonFiles.setFixedSize(890, 80)
                    ...
                    text.setFont(QFont(self.font2, 10))
                    text.move(80, 30)
                    text.setStyleSheet("""
                        color: white;
                        border: 0px;
                    ...
                    ################################################################################
                    self.filesVLayout.addWidget(self.buttonFiles)
