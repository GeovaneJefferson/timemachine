...
src_restore_icon = f"{homeUser}/.local/share/timemachine/src/icons/restore_84px.svg"
src_backup_icon = f"{homeUser}/.local/share/timemachine/src/icons/backup_128px.svg"
...
src_system_bar_icon = f"{homeUser}/.local/share/timemachine/src/icons/systemtrayicon.svg"
src_system_bar_run_icon = f"{homeUser}/.local/share/timemachine/src/icons/systemtrayiconrun.svg"
src_system_bar_error_icon = f"{homeUser}/.local/share/timemachine/src/icons/systemtrayiconerror.svg"
src_system_bar_restore_icon = f"{homeUser}/.local/share/timemachine/src/icons/systemtrayiconrestore.svg"
