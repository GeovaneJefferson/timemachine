...
################################################################################
## Form generated from reading UI file 'new_2mainwindow.ui'
##
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.progressbar_main_window.setMaximumSize(QSize(16777215, 11))
        self.progressbar_main_window.setFont(font3)
        self.progressbar_main_window.setMaximum(0)
        self.progressbar_main_window.setValue(-1)
        self.progressbar_main_window.setTextVisible(False)
